      ...
      <div className="max-w-4xl w-full bg-white rounded-lg shadow-md p-12 mt-12 mb-12">
        ...
        <div className="text-center mb-12">
          ...
          <p className="text-lg text-gray-600 max-w-2xl mx-auto">
            Access classical Sanskrit readers with integrated notes,
            annotations, and linked dictionary resources for enhanced learning
          </p>
        </div>
          ...
          <div className="grid md:grid-cols-2 gap-6">
            ...
            >
              ...
              <p className="text-gray-600 text-sm">
                A comprehensive introduction to Sanskrit literature with
            ...
            >
              ...
              <p className="text-gray-600 text-sm">
                Classical texts with extensive annotations and linguistic
                commentary
              </p>
            </a>
          </div>
